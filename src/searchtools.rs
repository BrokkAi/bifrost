...
fn location_selector_failure(
    ...
    let hint = usage_failure_hint(ScanUsagesSurface::Location, reason_kind, true, false);
...
";
    ...
    fn no_graph_seed_hint_uses_reference_arguments_for_symbol_queries() {
        let anchored =
            usage_failure_hint(ScanUsagesSurface::Reference, "no_graph_seed", true, false).unwrap();
        assert!(
        ...
        let unanchored =
            usage_failure_hint(ScanUsagesSurface::Reference, "no_graph_seed", false, false)
                .unwrap();
        assert!(
