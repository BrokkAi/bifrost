...
use crate::analyzer::{
    AliasResolver, CodeUnit, IAnalyzer, JavaAnalyzer, Language, PhpAnalyzer, ProjectFile,
    PythonAnalyzer, Range, parse_php_use_aliases_from_source,
};
...
fn resolve_one(
    ...
    let resolved = match language {
        ...
        Language::Cpp | Language::Scala | Language::CSharp | Language::None => {
