...
pub use protocol::{
    ...
    ProtocolEventId, ProtocolEventKey, ProtocolEventOccurrence, ProtocolEventSpec,
    ProtocolExpectationId, ProtocolExpectationKey, ProtocolGuardSpec, ProtocolKeyError,
