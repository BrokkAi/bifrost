...
use lsp_types::request::{
    DocumentSymbolRequest, GotoDefinition, HoverRequest, References, Request as LspRequestTrait,
...
use crate::lsp::handlers::{definition, document_symbol, hover, references, workspace_symbol};
