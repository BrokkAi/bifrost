...
use crate::common::usage_graph::{assert_every_edge_endpoint_is_a_node, find_edge};
use brokk_bifrost::{Language, SearchToolsService};
use serde_json::Value;

fn usage_graph() -> Value {
    let fixture_root = crate::common::copy_fixture_to_temp("usage-graph-rust");
...
"#,
    ...
    let value = crate::common::usage_graph::usage_graph_at(project.root(), "{}");
    assert!(
