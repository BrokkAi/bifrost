...
#[test]
#[ignore = "stress: generated 24-layer Go embedding navigation; run explicitly with cargo test --test suite_mcp_cli -- lsp_click_around_regression:: --ignored"]
...
#[test]
#[ignore = "stress: generated 16-type Rust trait-implementation navigation; run explicitly with cargo test --test suite_mcp_cli -- lsp_click_around_regression:: --ignored"]
