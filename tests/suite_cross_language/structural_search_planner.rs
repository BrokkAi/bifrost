...
use brokk_bifrost::analyzer::structural::{
    ...
    CodeQueryExecutionLimits, CodeQueryResult, EnvironmentAxis, FileFacts, NormalizedKind,
    OccurrenceRole, Role, StructuralSearchProvider, execute, execute_with_limits,
};
use brokk_bifrost::{
