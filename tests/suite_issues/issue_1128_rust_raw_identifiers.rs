...
use crate::common::{InlineTestProject, call_tool, symbol_sources};
...
fn db_column_project() -> crate::common::BuiltInlineTestProject {
...
fn other_raw_identifier_kinds_project() -> crate::common::BuiltInlineTestProject {
    InlineTestProject::with_language(Language::Rust)
        .file(
            "src/kinds.rs",
