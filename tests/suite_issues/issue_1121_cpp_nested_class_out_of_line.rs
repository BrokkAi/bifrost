...
use crate::common::{InlineTestProject, call_tool, sorted_source_paths, symbol_sources};
...
fn scan_usages(project: &crate::common::BuiltInlineTestProject, symbol: &str) -> Value {
    call_tool(
        project,
...
/// its own).
fn namespace_block_project() -> crate::common::BuiltInlineTestProject {
