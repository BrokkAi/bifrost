...
class SearchToolsClient:
    ...
    def query_code(
        ...
        *,
        ...
        The compatible head is schema version 11, which adds the
        ...
        provenance. The previous head, schema version 10, added the ``paths``
        source plus the ``segments_of`` and ``segment_target`` steps over
        qualified-path rows. Before it, schema version 9 added the ``scopes``
