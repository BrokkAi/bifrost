...
- `member_targets` returns exact workspace or semantic-model members together with the receiver owner that justified each target.

Every analyzed input produces a typed outcome row. `points_to` and `receiver_targets` emit `receiver_analysis`; `member_targets` emits `member_target_analysis` with explicit coverage and exact receiver/member identities. Read `outcome` before using candidates: `precise`, `ambiguous`, `unknown`, `unsupported`, and `exceeded_budget` are distinct states. This is not whole-program points-to, general alias analysis, path-sensitive control flow, taint, or data-flow analysis.

> Last verified end to end: 2026-08-31 (`query_code` schema version 1).
...
```json
{"results":[{"coverage":"exhaustive","input_kind":"receiver","language":"typescript","member_range":{"end_column":13,"end_line":19,"start_column":10,"start_line":19},"member_targets":[{"declaration":{"end_line":2,"fq_name":"Service.run","kind":"function","language":"typescript","path":"receiver.ts","signature":"run() { ... }","start_line":2},"end_line":2,"fq_name":"Service.run","id":"decl:v1:086a906933d15e9714fc034c3f11f6e9363a0d0c545f73fe5db0ab992fbae19e","kind":"function","language":"typescript","name":"run","path":"receiver.ts","receiver_declaration":{"end_line":3,"fq_name":"Service","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Service {","start_line":1},"receiver_fq_name":"Service","receiver_id":"decl:v1:441a4f4afe3383243aaa9a0e3e464f314d42120410cd2a8f3d4113667ff9ee99","receiver_kind":"class","signature":"run() { ... }","start_line":2}],"outcome":"precise","path":"receiver.ts","provenance":[{"seed":{"end_line":19,"kind":"call","path":"receiver.ts","result_type":"structural_match","start_line":19},"steps":[{"op":"member_targets","result":{"coverage":"exhaustive","outcome":"precise","path":"receiver.ts","receiver_range":{"end_column":9,"end_line":19,"start_column":3,"start_line":19},"result_type":"member_target_analysis","site_id":"bdfe81a1b0bccb0de4c0002130f09ee83c239843e8768962e8a60cdb16de3a4d"}}]}],"range":{"end_column":9,"end_line":19,"start_column":3,"start_line":19},"result_type":"member_target_analysis","site_ast_id":"d30a656bec6f731dff30e4c6f3b1ba6c8f37c6c705929bd92adfecd0d3850a06","site_id":"bdfe81a1b0bccb0de4c0002130f09ee83c239843e8768962e8a60cdb16de3a4d","text":"direct"}],"truncated":false}
```
...
```json
{"results":[{"analysis_kind":"receiver_targets","input_kind":"identifier","language":"typescript","outcome":"ambiguous","path":"receiver.ts","provenance":[{"seed":{"end_line":25,"kind":"call","path":"receiver.ts","result_type":"structural_match","start_line":25},"steps":[{"op":"receiver_targets","result":{"analysis_kind":"receiver_targets","outcome":"ambiguous","path":"receiver.ts","range":{"end_column":12,"end_line":25,"start_column":3,"start_line":25},"result_type":"receiver_analysis"}}]}],"range":{"end_column":12,"end_line":25,"start_column":3,"start_line":25},"result_type":"receiver_analysis","site_ast_id":"83c828f8a8013c5d1266eb54f28c624eb5949b93a7d77ae90fdb61d36b74fa49","site_id":"cd48f82325900d406677e5217506fa5f62aebf3d7ae1b4096f0fa625f11eb04e","text":"ambiguous","values":[{"allocation_site":{"path":"receiver.ts","range":{"end_column":41,"end_line":24,"start_column":28,"start_line":24}},"receiver_value_kind":"allocation_site","type_declaration":{"end_line":3,"fq_name":"Service","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Service {","start_line":1}},{"allocation_site":{"path":"receiver.ts","range":{"end_column":55,"end_line":24,"start_column":44,"start_line":24}},"receiver_value_kind":"allocation_site","type_declaration":{"end_line":7,"fq_name":"Other","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Other {","start_line":5}}]}],"truncated":false}
```
...
```json
{"results":[{"coverage":"exhaustive","input_kind":"receiver","language":"typescript","member_range":{"end_column":12,"end_line":14,"start_column":9,"start_line":14},"member_targets":[{"declaration":{"end_line":2,"fq_name":"Service.run","kind":"function","language":"typescript","path":"receiver.ts","signature":"run() { ... }","start_line":2},"end_line":2,"fq_name":"Service.run","id":"decl:v1:086a906933d15e9714fc034c3f11f6e9363a0d0c545f73fe5db0ab992fbae19e","kind":"function","language":"typescript","name":"run","path":"receiver.ts","receiver_declaration":{"end_line":3,"fq_name":"Service","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Service {","start_line":1},"receiver_fq_name":"Service","receiver_id":"decl:v1:441a4f4afe3383243aaa9a0e3e464f314d42120410cd2a8f3d4113667ff9ee99","receiver_kind":"class","signature":"run() { ... }","start_line":2}],"outcome":"precise","path":"receiver.ts","provenance":[{"seed":{"end_line":2,"kind":"method","path":"receiver.ts","result_type":"structural_match","start_line":2},"steps":[{"op":"enclosing_decl","result":{"end_line":2,"fq_name":"Service.run","kind":"method","path":"receiver.ts","result_type":"declaration","start_line":2}},{"op":"references_of","result":{"path":"receiver.ts","proof":"proven","range":{"end_column":12,"end_line":14,"start_column":9,"start_line":14},"reference_kind":"method_call","result_type":"reference_site","target_fq_name":"Service.run"}},{"op":"member_targets","result":{"coverage":"exhaustive","outcome":"precise","path":"receiver.ts","receiver_range":{"end_column":8,"end_line":14,"start_column":3,"start_line":14},"result_type":"member_target_analysis","site_id":"df0e9f4bf510efeb6c0c37365e0424af81b20d18da1631834408a519d45e5acc"}}]}],"range":{"end_column":8,"end_line":14,"start_column":3,"start_line":14},"result_type":"member_target_analysis","site_ast_id":"26076d2185a529f34c83122279920e67cbb1409744865acf61bd3ab8c55df949","site_id":"df0e9f4bf510efeb6c0c37365e0424af81b20d18da1631834408a519d45e5acc","text":"value"},{"coverage":"exhaustive","input_kind":"receiver","language":"typescript","member_range":{"end_column":13,"end_line":19,"start_column":10,"start_line":19},"member_targets":[{"declaration":{"end_line":2,"fq_name":"Service.run","kind":"function","language":"typescript","path":"receiver.ts","signature":"run() { ... }","start_line":2},"end_line":2,"fq_name":"Service.run","id":"decl:v1:086a906933d15e9714fc034c3f11f6e9363a0d0c545f73fe5db0ab992fbae19e","kind":"function","language":"typescript","name":"run","path":"receiver.ts","receiver_declaration":{"end_line":3,"fq_name":"Service","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Service {","start_line":1},"receiver_fq_name":"Service","receiver_id":"decl:v1:441a4f4afe3383243aaa9a0e3e464f314d42120410cd2a8f3d4113667ff9ee99","receiver_kind":"class","signature":"run() { ... }","start_line":2}],"outcome":"precise","path":"receiver.ts","provenance":[{"seed":{"end_line":2,"kind":"method","path":"receiver.ts","result_type":"structural_match","start_line":2},"steps":[{"op":"enclosing_decl","result":{"end_line":2,"fq_name":"Service.run","kind":"method","path":"receiver.ts","result_type":"declaration","start_line":2}},{"op":"references_of","result":{"path":"receiver.ts","proof":"proven","range":{"end_column":13,"end_line":19,"start_column":10,"start_line":19},"reference_kind":"method_call","result_type":"reference_site","target_fq_name":"Service.run"}},{"op":"member_targets","result":{"coverage":"exhaustive","outcome":"precise","path":"receiver.ts","receiver_range":{"end_column":9,"end_line":19,"start_column":3,"start_line":19},"result_type":"member_target_analysis","site_id":"bdfe81a1b0bccb0de4c0002130f09ee83c239843e8768962e8a60cdb16de3a4d"}}]}],"range":{"end_column":9,"end_line":19,"start_column":3,"start_line":19},"result_type":"member_target_analysis","site_ast_id":"d30a656bec6f731dff30e4c6f3b1ba6c8f37c6c705929bd92adfecd0d3850a06","site_id":"bdfe81a1b0bccb0de4c0002130f09ee83c239843e8768962e8a60cdb16de3a4d","text":"direct"},{"coverage":"exhaustive","input_kind":"receiver","language":"typescript","member_range":{"end_column":14,"end_line":22,"start_column":11,"start_line":22},"member_targets":[{"declaration":{"end_line":2,"fq_name":"Service.run","kind":"function","language":"typescript","path":"receiver.ts","signature":"run() { ... }","start_line":2},"end_line":2,"fq_name":"Service.run","id":"decl:v1:086a906933d15e9714fc034c3f11f6e9363a0d0c545f73fe5db0ab992fbae19e","kind":"function","language":"typescript","name":"run","path":"receiver.ts","receiver_declaration":{"end_line":3,"fq_name":"Service","kind":"class","language":"typescript","path":"receiver.ts","signature":"class Service {","start_line":1},"receiver_fq_name":"Service","receiver_id":"decl:v1:441a4f4afe3383243aaa9a0e3e464f314d42120410cd2a8f3d4113667ff9ee99","receiver_kind":"class","signature":"run() { ... }","start_line":2}],"outcome":"precise","path":"receiver.ts","provenance":[{"seed":{"end_line":2,"kind":"method","path":"receiver.ts","result_type":"structural_match","start_line":2},"steps":[{"op":"enclosing_decl","result":{"end_line":2,"fq_name":"Service.run","kind":"method","path":"receiver.ts","result_type":"declaration","start_line":2}},{"op":"references_of","result":{"path":"receiver.ts","proof":"proven","range":{"end_column":14,"end_line":22,"start_column":11,"start_line":22},"reference_kind":"method_call","result_type":"reference_site","target_fq_name":"Service.run"}},{"op":"member_targets","result":{"coverage":"exhaustive","outcome":"precise","path":"receiver.ts","receiver_range":{"end_column":10,"end_line":22,"start_column":3,"start_line":22},"result_type":"member_target_analysis","site_id":"19d81f677c0894963a7ff10b8a29e6b83bc4aa57769aab201360306f4917da6e"}}]}],"range":{"end_column":10,"end_line":22,"start_column":3,"start_line":22},"result_type":"member_target_analysis","site_ast_id":"9218d24672d364d35f0192fa68014ebec561c2c259231819235210b1a8d03f35","site_id":"19d81f677c0894963a7ff10b8a29e6b83bc4aa57769aab201360306f4917da6e","text":"factory"}],"truncated":false}
```
...
- `receiver_evidence` projects one row per retained receiver observation. Rows carry stable `site_id`/`id` keys, so a policy joins evidence to its outcome (and to occurrence rows via `site_ast_id`) by identity, never by range or spelling. Resolved `declaration_id` and `factory_id` fields use the same analyzer `decl:v1:<hex>` value as declaration rows. Each row also carries the analyzed receiver `range` so a finding can anchor its source location after identity-based selection.
