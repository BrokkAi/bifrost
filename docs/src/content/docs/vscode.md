...
The extension associates `.rune` files with **Bifrost Rune IR** and uses that
language mode for **Bifrost: Show Rune IR** previews. Canonical kinds, roles,
metadata, spans, strings, and `;` comments receive syntax highlighting.
