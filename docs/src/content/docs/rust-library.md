...
`brokk-bifrost-analysis`, `brokk-bifrost-policy`, `brokk-bifrost-nlp`,
`brokk-bifrost-runtime`, and `brokk-bifrost-mcp` are lower-level workspace
components. They are published
