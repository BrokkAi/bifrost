...
`brokk-bifrost-core`, `brokk-bifrost-csharp`, `brokk-bifrost-go`,
`brokk-bifrost-php`, `brokk-bifrost-python`, `brokk-bifrost-ruby`,
`brokk-bifrost-rust`, `brokk-bifrost-analysis`,
