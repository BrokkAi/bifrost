...
use crate::analyzer::{CodeUnit, ImportAnalysisProvider, ProjectFile, TypeAliasProvider};
...
use super::usage_index::{RustUsageIndex, exported_targets_from_files};
...
pub(crate) trait RustAnalysisSource:
    CodeUnitIndex + ImportAnalysisProvider + TypeAliasProvider
{
...
pub(crate) trait RustUsageSource: RustAnalysisSource {
...
#[derive(Debug, Default)]
pub(crate) struct RustPackageFileIndex {
...
pub(crate) fn export_index_of_declarations(
...
pub(crate) fn resolve_module_package(
    rust: &dyn RustAnalysisSource,
...
pub(crate) fn forward_exported_targets_from_files(
    rust: &dyn RustAnalysisSource,
    module_files: &[ProjectFile],
    export_name: &str,
...
pub(crate) fn rust_member_reexport_targets(
    rust: &dyn RustAnalysisSource,
    file: &ProjectFile,
    owner_path: &str,
    member_name: &str,
...
pub(crate) fn rust_apply_import_alias(
    rust: &dyn RustAnalysisSource,
    importing_file: &ProjectFile,
    module_specifier: &str,
) -> Option<String> {
...
pub(crate) fn trait_implementer_names(
    rust: &dyn RustAnalysisSource,
...
pub(crate) fn is_rust_trait_declaration(index: &dyn CodeUnitIndex, code_unit: &CodeUnit) -> bool {
    rust_declaration_node_is(index, code_unit, |node, _source| {
        node.kind() == "trait_item"
    })
}

pub(crate) fn is_rust_trait_impl_member_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
    rust_declaration_node_is(index, code_unit, |node, _source| {
...
pub(crate) fn is_rust_struct_declaration(index: &dyn CodeUnitIndex, code_unit: &CodeUnit) -> bool {
    rust_declaration_node_is(index, code_unit, |node, _source| {
        node.kind() == "struct_item"
    })
}

pub(crate) fn has_rust_value_constructor(index: &dyn CodeUnitIndex, code_unit: &CodeUnit) -> bool {
    rust_declaration_node_is(index, code_unit, |node, source| {
        rust_value_constructor_visibilities(node, source).is_some()
    })
}

pub(crate) fn is_rust_enum_declaration(index: &dyn CodeUnitIndex, code_unit: &CodeUnit) -> bool {
    rust_declaration_node_is(index, code_unit, |node, _source| node.kind() == "enum_item")
}

pub(crate) fn is_rust_const_or_static_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
    rust_declaration_node_is(index, code_unit, |node, _source| {
...
pub(crate) fn is_rust_type_alias_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
...
pub(crate) fn is_rust_macro_export_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
    code_unit.is_macro()
...
pub(crate) fn is_rust_public_like_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
    rust_declaration_node_is(index, code_unit, |node, source| {
...
pub(crate) fn rust_declaration_visibility(
    rust: &dyn RustAnalysisSource,
    code_unit: &CodeUnit,
) -> RustVisibility {
...
pub(crate) fn is_rust_export_visible_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
...
pub(crate) fn is_export_public_declaration(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
) -> bool {
    rust_declaration_node_is(index, code_unit, |node, source| {
...
pub(crate) fn export_visible_declarations(
    index: &dyn CodeUnitIndex,
    file: &ProjectFile,
    declarations: &BTreeSet<CodeUnit>,
) -> HashSet<CodeUnit> {
...
pub(crate) fn is_module_export_candidate(
    index: &dyn CodeUnitIndex,
    file: &ProjectFile,
    code_unit: &CodeUnit,
...
pub(crate) fn is_visible_module_path(index: &dyn CodeUnitIndex, code_unit: &CodeUnit) -> bool {
    let mut current = code_unit.clone();
    loop {
...
pub(crate) fn is_external_module_declaration(
    rust: &dyn RustAnalysisSource,
    code_unit: &CodeUnit,
) -> bool {
...
pub(crate) fn rust_declaration_node_is<F>(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
    predicate: F,
) -> bool
...
pub(crate) fn rust_named_declaration_node<'tree>(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
    root: Node<'tree>,
    source: &str,
...
pub(crate) fn rust_declaration_node<'tree>(
    index: &dyn CodeUnitIndex,
    code_unit: &CodeUnit,
    root: Node<'tree>,
) -> Option<Node<'tree>> {
