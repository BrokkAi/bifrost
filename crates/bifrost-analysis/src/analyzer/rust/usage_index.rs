...
#[derive(Debug, Default)]
pub(crate) struct RustUsageIndex {
...
impl RustUsageIndex {
    ...
    pub(super) fn build(rust: &dyn RustAnalysisSource, parallel: bool) -> Self {
        ...
        let macro_visible_ranges = {
            ...
            build_macro_visible_ranges(
                rust.code_units(),
                &declaration_identities,
                build_macro_scope_edges(rust, &files, &module_files, &physical_owners, parallel),
            )
        };
