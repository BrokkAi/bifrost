...
trait FlowEventSpec {
    ...
    fn carrier(&self) -> &brokk_bifrost_flow::value_flow::ValueFlowCarrier;
}
...
impl FlowEventSpec for brokk_bifrost_flow::value_flow::ValueFlowSinkSpec {
    fn locator(&self) -> &SemanticLocator {
        self.key().site()
    }
    ...
    fn carrier(&self) -> &brokk_bifrost_flow::value_flow::ValueFlowCarrier {
        brokk_bifrost_flow::value_flow::ValueFlowSinkSpec::carrier(self)
    }
}
...
pub(crate) fn public_witness_step(
    workspace: &WorkspaceAnalyzer,
    step: &brokk_bifrost_flow::dataflow::SummaryWitnessStep,
