...
pub struct CodeQueryProfileRequestTimings {
    ...
    /// Time from MCP request acceptance until the deferred workspace is ready.
    pub workspace_readiness_wait: u64,
    /// Time spent waiting for an analyzer execution slot after workspace readiness.
    pub analyzer_admission_wait: u64,
...
mod public_contract_tests {
    ...
    use super::*;
    use crate::structural::execution::plan::{LogicalQueryOperator, LogicalQueryPlan};
