...
use crate::analyzer::semantic::{
    CapabilitySupport, ContentIdentity, LengthDelimitedDigest, MemoryAccessKind, MemoryLocationId,
    MemoryLocationKind, ProcedureHandle, ProcedureId, ProcedureSemantics, ProgramPointHandle,
    ProgramPointId, SemanticArtifact, SemanticBudget, SemanticCapability, SemanticEffect,
    SemanticGapKind, SemanticLocator, SemanticOutcome, SemanticRequest, SemanticValueKind,
    SemanticWork, SourceMappingId, SourceSpan, ValueId,
};
