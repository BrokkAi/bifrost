...
impl BalancedWriter {
    ...
    pub fn open(&mut self, depth: usize, line: &str) -> bool {
    ...
    pub fn line(&mut self, depth: usize, line: &str) -> bool {
    ...
    pub fn close(&mut self, depth: usize) -> bool {
...
pub const fn quoted(value: &str) -> Quoted<'_> {
    Quoted(value)
}
