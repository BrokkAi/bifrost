-- Preserve the unmodeled guard reason and its class as separate queryable
-- columns. Rebuild the constrained leaf table while retaining existing rows.

CREATE TABLE class_set_finding_free_root_rows_v61 (
...
INSERT INTO class_set_finding_free_root_rows_v61(
...
ALTER TABLE class_set_finding_free_root_rows_v61
