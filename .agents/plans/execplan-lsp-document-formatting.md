...
This document follows `.agents/PLANS.md` from the repository root. It is self-contained so a future contributor can resume the work from this file and the current tree alone.
