...
- [x] (2026-07-18) Completed the authoritative `bafba979` Scala baseline audit. `/mnt/optane/tmp/reference-differential/scala-top5-bafba979-oldskool-audit.jsonl` (SHA-256 `09496157692d2344f902c5cafa21a37d30b149525e5fe8e7b5074785e3236798`) contains exactly one reconciled ledger record for every one of the 1,105 raw missing rows; its canonical sorted raw and ledger keys are identical at SHA-256 `c704ab8d54d5a25d01cc278c256293577144ebc637e53575fdd801092272463d`. The exact disposition is #661 137, #662 27, #663 134, #664 47, Java #128 90, non-acceptance 180, and physical source-set/platform ambiguity 490; no semantic row is left unrouted and #913 did not occur in this sample.
