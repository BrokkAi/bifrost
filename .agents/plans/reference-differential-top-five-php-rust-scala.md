...
- [ ] Complete, integrate, prove, and summarize the Scala top-five leg. Assigned #908 is checkpointed at `cd131d74`: source-free bulk hierarchy projection reduces Scala3 descendant construction from about 120.8s to 3.35s and preserves exact class/companion/source identity. The watcher-safe full feature gate passed by running the aggregate one-thread suite without its 43 selector and nine benchmark cases, then running all 52 excluded cases individually in fresh processes; the one aggregate service failure at the host's fixed watcher ceiling also passed alone. Assigned #910 and subsequent structured Scala fixes are checkpointed through clean detached `d7e1b037`. From cold publication caches, `scala-top5-d7e1b037.jsonl` completed all five repositories with zero file errors in 35m53s at 4.53 GiB peak RSS and produced 1,846 raw missing rows. Two independent row-level audits reconcile them exactly to 955 owned inverse defects (#661 767, #662 123, #663 65), 91 Java-target skips covered by closed David-owned #128, 288 non-acceptance rows, 298 single wrong-forward rows, and 214 multi-target ambiguities. The authoritative ledger is `scala-top5-d7e1b037-missing-ledger.jsonl` with SHA-256 `d79470b572a03f5834b5932a9bf4e5935b07a82689f4f51180d3745fcef01a0a`; the independent audit agrees after direct-source review of the two initially disputed rows. Assigned #664 additionally covers exactly five surviving forward identities. Delegated implementations and independent exact review are in progress; final watcher-safe gates, clean pushed-head corpora, and issue closures remain.
