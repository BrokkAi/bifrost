...
- [x] (2026-07-18) Completed and corrected the authoritative `bafba979` Scala baseline audit. The immutable original `/mnt/optane/tmp/reference-differential/scala-top5-bafba979-oldskool-audit.jsonl` (SHA-256 `09496157692d2344f902c5cafa21a37d30b149525e5fe8e7b5074785e3236798`) contains exactly one row for every one of the 1,105 raw misses, but root review found five ownership mistakes: one Java target belongs to David-owned #128, one synthetic constructor and three receiver-bound infix calls belong to #662. The corrected routing authority is `/mnt/optane/tmp/reference-differential/scala-top5-bafba979-corrected-audit.jsonl` (SHA-256 `10ec8ece4a781076277c04c8b50ae455c9d13c8f2b18aa18a86b27ef81965e20`), with #661 137, #662 31, #663 129, #664 47, Java #128 91, non-acceptance 180, and physical source-set/platform ambiguity 490. All 1,105 audit keys are preserved, no semantic row is left unrouted, and #913 did not occur in this sample.
