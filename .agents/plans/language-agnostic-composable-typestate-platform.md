...
- [x] (2026-07-24 14:12+02:00) Completed #819: added crate-internal bounded iterative reachability, DFS/RPO, Kosaraju SCC, SCC-derived loop-region, and shortest-path utilities; reused reachability for ICFG return-gap scoping; retained only its artifact-local memo; and recorded dominators/post-dominators as an evidence-backed no-go until a named client justifies them.
