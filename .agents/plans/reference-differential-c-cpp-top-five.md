...
- [ ] File or reuse issues assigned only to `jbellis`, delegate substantial implementations to Oldskool, root-review each change, and prove fixes with focused tests and exact production reruns. (Completed: filed and assigned #924 through #932; committed reviewed fixes for #924, #928, and #929; #925 is under root review; #926, #927, and #930 are delegated and active. Remaining: accept those implementations, implement #931 and #932, reduce any residual receiver/type-environment families not covered by the filed issues, and run exact production proofs.)
