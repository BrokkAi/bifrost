...
What remains for the next milestone: nothing in the product reads these rows. The reader exists and is tested, but `RustUsageIndex` still answers every usage query.
