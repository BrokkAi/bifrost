...
- [ ] Production-prove #945 on .NET runtime, then complete and integrity-check the C# top-five baseline and exhaustively classify the .NET runtime and Roslyn raw missing rows.
