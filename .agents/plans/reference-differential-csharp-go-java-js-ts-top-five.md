...
- [ ] Implement, review, and exact-prove sole remaining assigned C# issue #701, then complete and integrity-check the C# top-five baseline and exhaustively classify Roslyn raw missing rows.
