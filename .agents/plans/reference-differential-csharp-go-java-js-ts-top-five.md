...
- [ ] Cleanly exact-prove and close #954, then complete and integrity-check the C# top-five baseline with a 250,000 per-file candidate ceiling and exhaustively classify all final raw rows, including Roslyn.
