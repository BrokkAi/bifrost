...
- [ ] Campaign: per-language depth-first passes over top-20 repos; file/fix/close/merge; per-language summary. Rediscovery audit against #1526/#1527/#1528/#1537/#1377 (#1376 already fixed and closed).
  ...
  - [ ] PYTHON fix phase: #1762 (export-entry module form), #1763 (annotation resolver is_class filter + extractor fallback gate), #1764 (nested re-export collector) - all mine, all in the python crates; then python summary to Jonathan.
