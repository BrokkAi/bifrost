...
- [ ] Milestone 3: budget-scaling follow-up filed as #1771 (2026-08-07); remaining: implement workspace-scaled policy scan budgets for the policy evaluation path, with tests.
